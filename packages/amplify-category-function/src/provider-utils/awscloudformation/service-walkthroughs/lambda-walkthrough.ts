...
import { lambdaCustomParameters } from './lambdaCustomParameters';
...
export async function updateWalkthrough(context, lambdaToUpdate?: string) {
  ...
  if (
    ...
    merge(functionParameters, await lambdaCustomParameters(context, functionParameters, currentParameters));
